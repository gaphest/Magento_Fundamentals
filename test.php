...
//получаем из массива _data объекта $product поле name
echo $product->getData("name");

//сделает тоже самое - getПоле (изначально метода getName в системе нету)
//а происходит это потому что если мы вызываем неизвестный метод перед тем как выкинуть error
