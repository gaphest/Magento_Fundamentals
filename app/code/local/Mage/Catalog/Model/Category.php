<!--Воссоздал путь как у app/code/core/Mage/Catalog/Model/Category.php только не core а local -->
<!--Теперь копию category.php могу менять (например override существующих методов)-->
