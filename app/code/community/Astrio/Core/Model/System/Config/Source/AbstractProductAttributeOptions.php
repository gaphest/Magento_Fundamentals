 ...
 */
class Astrio_Core_Model_System_Config_Source_AbstractProductAttributeOptions extends Astrio_Core_Model_System_Config_Source_Abstract
{
    ...
    protected static function _getOptionArray()
    {
        ...
        if ($attrCode) {
            ...
            $attribute = $productResource->getAttribute($attrCode);
