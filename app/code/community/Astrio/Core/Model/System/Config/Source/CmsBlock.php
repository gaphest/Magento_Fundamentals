 ...
 */
class Astrio_Core_Model_System_Config_Source_CmsBlock extends Astrio_Core_Model_System_Config_Source_Abstract
{
    ...
    protected static $_emptyValueLabel = '-- Please Select a Block --';
