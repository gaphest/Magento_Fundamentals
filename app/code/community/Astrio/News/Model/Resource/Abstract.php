 ...
 */
abstract class Astrio_News_Model_Resource_Abstract extends Mage_Eav_Model_Entity_Abstract
{
    ...
    {
        return 'astrio_news/resource_eav_attribute';
    }
     ...
     *
     * @param  Mage_Eav_Model_Entity_Attribute_Abstract|Mage_Eav_Model_Entity_Attribute_Backend_Abstract|Mage_Eav_Model_Entity_Attribute_Frontend_Abstract|Mage_Eav_Model_Entity_Attribute_Source_Abstract $instance instance
     ...
     *
     * @param  Mage_Catalog_Model_Abstract $object   object
     * @param  array                       $valueRow value row
     ...
     * @param  array                                    $origData  original data
     * @return bool
     */
     ...
     * @param  int|Mage_Core_Model_Store $store     store object or id
