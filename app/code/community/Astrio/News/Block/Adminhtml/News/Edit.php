 ...
 */
class Astrio_News_Block_Adminhtml_News_Edit extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        parent::__construct();
        $this->setTemplate('astrio/news/news/edit.phtml');
        $this->setId('news_edit');
    }

    /**
     * Retrieve currently edited news object
     *
    ...
    {
        $header = '';
        if ($this->getNews()->getId()) {
            $header = $this->escapeHtml($this->getNews()->getTitle());
        } else {
            $header = Mage::helper('astrio_news')->__('New News');
        }
