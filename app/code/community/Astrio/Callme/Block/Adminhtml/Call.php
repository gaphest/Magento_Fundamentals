 ...
 */
class Astrio_Callme_Block_Adminhtml_Call extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('astrio_callme')->__('Calls Manager');
        parent::__construct();
