 ...
 */
class Astrio_Callme_Model_Resource_Call_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     * Constructor
     */
     ...
     * Add status filter
     *
     * @param Varien_Object|string $status status string or Varien_Object containing one
     * @return $this
     */
