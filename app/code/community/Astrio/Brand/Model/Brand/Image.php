 ...
 */
class Astrio_Brand_Model_Brand_Image extends Mage_Core_Model_Abstract
{
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getBaseDir('media') . DS . 'astrio' . DS . 'brand';
        ...
        $path = array(
            Mage::getBaseDir('media') . DS . 'astrio' . DS . 'brand',
            'cache',
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'astrio'.DS.'brand'.DS.'cache'.DS;
