 ...
 */
class Astrio_Documentation_Block_Adminhtml_Documentation_Document_Form_Element_File
    extends Varien_Data_Form_Element_Abstract
{
    ...
    {
        return $this->getPreviewUrl() ? $this->getPreviewUrl() : Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA)
            . Astrio_Documentation_Model_Document::FILE_PATH
            . $this->getValue();
    }
